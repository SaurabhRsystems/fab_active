...
class ContactGroup(Model):
    id = Column(Integer, primary_key=True)
    name = Column(String(50), unique = True, nullable=False)
    # contact_sub_group_id = Column(Integer, ForeignKey('contact_sub_group.id'),nullable=True)
...
class Employee(Model):
    ...
    address = Column(Text(250), nullable=True)
    ...
    begin_date = Column(Date, default=today, nullable=True)
